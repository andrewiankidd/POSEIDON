...
//!
//! - **Standalone** - this shell embeds a full [`poseiden_server::Service`] +
//!   [`poseiden_server::Scheduler`] over a local SQLite store, and the webview
...
//!
//! Either way the *logic* is `poseiden-server`'s `Service` - the same code the
...
pub fn run() {
    tauri::Builder::default()
        ...
        .expect("error while running POSEIDEN");
}
