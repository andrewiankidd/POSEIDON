//! Centralised, portable observability for POSEIDON (and reusable across Rust
...
//!
//! Every other POSEIDON crate logs through the `tracing` facade (`info!`,
...
//!
//! ```no_run
//! use poseidon_telemetry::{init, RuntimeInfo, Environment, TelemetrySettings};
//! # fn main() -> Result<(), poseidon_telemetry::TelemetryError> {
...
fn file_layer(
    ...
    let appender = tracing_appender::rolling::daily(&rt.log_dir, "poseidon.log");
