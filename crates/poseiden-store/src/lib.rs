//! POSEIDEN persistence - SQLite via `sqlx`.
//!
...
use poseiden_core::{
    Pipeline, PipelineReport, PipelineRun, PrStatus, PullRequest, ReportSpec, RunStatus, TagCount,
    TicketReport, UserConfig, WorkItem,
};
